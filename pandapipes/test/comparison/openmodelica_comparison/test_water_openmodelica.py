...
from pandapipes.test.comparison.pipeflow_comparison \
    import pipeflow_comparison
...
def test_case_combined_mixed_pc(log_results=False):
    ...
    p_diff, v_diff_abs = pipeflow_comparison(net, 'om', log_results, friction_model='colebrook')
